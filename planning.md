...
A confidence score of 0.6 would tell my system that while positive it is highly uncertain of whether is is human or not. The final confidence score will be the average of the two individual confidence values. The planned threshold values will be that from 1 to 0.76 will be "likely human", from 0.0 to 0.2 will be "likely AI" and 0.21 to 0.75 will be "uncertain". This gives a large range to uncertainty as to make the requirements for both "likely AI" and "likely human" more narrow. This narrowing allows for a very critical lens to ensure that if something is flagged as "likely human" it is because it has such a high confidence value. I would rather there be harsher standards as to strongly protect attribution. 
